...
export default function StickyCTA() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsAtBottom(scrollPercent > 0.9);
    };
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-surface-container border-t border-outline-variant p-3 animate-in slide-in-from-bottom duration-300">
      <div className="flex gap-3">
        ...
        <Link
          href="/#contacto"
          className="flex-1 flex items-center justify-center gap-2 bg-primary-container text-on-primary py-3 font-label-bold uppercase tracking-wider text-sm"
        >
